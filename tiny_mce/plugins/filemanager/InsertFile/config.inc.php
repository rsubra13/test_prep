...
*/
$MY_DOCUMENT_ROOT     = '../../../../test-images'; //* system path to the directory you want to manage the files and folders

/* MY_BASE_URL  Not used in htmlarea3-plugin version  */
$MY_BASE_URL          = "http://wt.epplersoft.com/test-images";
...
*/
$MY_URL_TO_OPEN_FILE  = "http://wt.epplersoft.com/test-images"; 
