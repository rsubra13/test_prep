<?php
	...
	// ================================================
	// Revision: 1.3.3                 Date: 05/03/2006
	// ================================================
...
/*		array (
	...
	$cfg['ilibs'] = array (																// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions	
		array (																		
			'value'   	=> '/test-images/' . $_REQUEST['TestID'] . '/',												
			'text'    	=> 'Test Media (' . $_REQUEST['TestID'] . ')',
		),
	);
	//-------------------------------------------------------------------------
	...
	$cfg['ilibs_dir'] 	   = array('/test-images/' . $_REQUEST['TestID'] . '/');						   	// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions
	...
	$cfg['ver'] 		= '1.3.3 - build 05032006';										// iBrowser version	
