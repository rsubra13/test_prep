...
?>
<!-- TemplateInfo codeOutsideHTMLIsLocked="true" --><!-- TemplateBeginEditable name="doctitle" -->
...
<div align="center"> 
  <table width="100%" height="50" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#333333" BORDERCOLORLIGHT="#999999" BORDERCOLORDARK="#333333">
    <tr> 
      ...
      <td align="center" valign="middle"><!-- TemplateBeginEditable name="CurrentArea" -->
        <p class="style4">Area Goes Here </p>
...
?>
		   ...
		   <!-- TemplateBeginEditable name="nav" --><a href="./index.php">WebTester</a><!-- TemplateEndEditable --></div></td>
    </tr>
    <tr> 
      <td align="center" valign="top">		<div align="left"><!-- TemplateBeginEditable name="Content Area" -->Content 
        goes here<!-- TemplateEndEditable --> </div>	<div class="hr"><hr /></div>
</td>
    </tr>
    <tr> 
      <td align="center" valign="top">
