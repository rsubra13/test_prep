...
?>
		   ...
		   <!-- InstanceBeginEditable name="nav" --><a href="index.php">WebTester</a> &gt; <a href="./preferences.php">Preferences</a> &gt; <a href="./reportTemplates.php">Report Templates</a> &gt; <a href="./editReportTemplate.php?ID=<?=$_REQUEST['reportID']?>">Edit Report Template</a> &gt; Add Custom Message<!-- InstanceEndEditable --></div></td>
    </tr>
    <tr> 
	  ...
	  $_SESSION['redirectTo'] = "addCustomMessage.php?reportID=" . $_REQUEST['reportID'];
	  $_SESSION['reportID'] = $_REQUEST['reportID'];
	  if (!file_exists("../test-images/" . $_REQUEST['TestID'])) {
	  	mkdir("../test-images/" . $_REQUEST['TestID']);
	  }
	  ?>
          <p align="left" class="style7">Add Custom Message</p>
        <form name="form1" method="post" action="insertCustomMessage.php">
          <table width="100%" border="0" cellpadding="0" cellspacing="2" onMouseOut="javascript:highlightTableRowVersionA(0);">
            <tr class="d1" onMouseOver="javascript:highlightTableRowVersionA(this, '#FFFF99');">
              <td bgcolor="#E2ECFF" valign="top"><span class="style1">Description:</span></td>
              <td width="298" bgcolor="#E2ECFF"><strong>
                <input name="desc" type="text" id="desc" size="60">
              </strong></td>
              <td width="95" valign="top" bgcolor="#E2ECFF">&nbsp;</td>
            </tr>
            <tr onMouseOver="javascript:highlightTableRowVersionA(this, '#FFFF99');">
              <td bgcolor="#E2ECFF" width="125" valign="top"><span class="style1">Message:</span>
                <div class="style1" id="safari" style="visibility:hidden">(HTML Editor not supported in Safari)</div></td>
              <td bgcolor="#E2ECFF">
			  <span class="style1">
                <textarea name="message" cols="80" rows="15" id="message"><?php
            ...
            <tr class="d1" onMouseOver="javascript:highlightTableRowVersionA(this, '#FFFF99');" title="Case insensitive.  If you enter an answer here, no other items will appear.">
              <td valign="top"><span class="style1">Minimum Points:</span></td>
              <td colspan="2"><strong>
                <input name="minPoints" type="text" id="minPoints" size="60">
              </strong></td>
            </tr>
            <tr class="d0" onMouseOver="javascript:highlightTableRowVersionA(this, '#FFFF99');" title="Case insensitive.  If you enter an answer here, no other items will appear.">
              <td width="125" valign="top"><span class="style1">Maximum Points:</span></td>
              <td colspan="2">
                <input name="maxPoints" type="text" id="maxPoints" size="60"></td>
            </tr>
            <tr> 
              <td colspan="3"> <div align="center" class="style1 style1"> 
                  <p>
