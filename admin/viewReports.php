		...
		$num_test_rows=mysql_num_rows($testsResult);
          ...
          <table class="style1 style5" width="100%"  border="0" cellspacing="2" cellpadding="0" onMouseOut="javascript:highlightTableRowVersionA(0);">
            <tr bgcolor="#C8D8FF"> 
              ...
              <td><a href="viewReports.php?sortOrder=LastName&TestID=<?=$_REQUEST['TestID']?>">Last Name</a></td>
              <td><a href="viewReports.php?sortOrder=FirstName&TestID=<?=$_REQUEST['TestID']?>">First 
                Name</a></td>
              <td><a href="viewReports.php?sortOrder=Notes&TestID=<?=$_REQUEST['TestID']?>"><?=$notes?></a></td>
              <td><a href="viewReports.php?sortOrder=TestName&TestID=<?=$_REQUEST['TestID']?>">Test Name</a></td>
              <td><a href="viewReports.php?sortOrder=TestID&TestID=<?=$_REQUEST['TestID']?>">Test ID</a></td>
              <td><a href="viewReports.php?sortOrder=Score&TestID=<?=$_REQUEST['TestID']?>">Score</a></td>
              <td><a href="viewReports.php?sortOrder=Pass&TestID=<?=$_REQUEST['TestID']?>">Pass?</a></td>
              <td><a href="viewReports.php?sortOrder=TotalTime&TestID=<?=$_REQUEST['TestID']?>">Time Taken</a></td>
              <td><a href="viewReports.php?sortOrder=StartTime&TestID=<?=$_REQUEST['TestID']?>">Start 
                Time</a></td>
              <td><a href="viewReports.php?sortOrder=EndTime&TestID=<?=$_REQUEST['TestID']?>">End Time</a></td>
              <td><a href="viewReports.php?sortOrder=NumCorrect&TestID=<?=$_REQUEST['TestID']?>">Scored Points</a></td>
              <td><a href="viewReports.php?sortOrder=NumPossible&TestID=<?=$_REQUEST['TestID']?>">Possible 
                Points</a></td>
