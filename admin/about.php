  ...
  <table width="100%" height="50" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#333333" BORDERCOLORLIGHT="#999999" BORDERCOLORDARK="#333333">
    <tr> 
      ...
      <td align="center" valign="middle"><!-- InstanceBeginEditable name="CurrentArea" -->
        <p class="style4">About WebTester </p>
...
?>
		   ...
		   <!-- InstanceBeginEditable name="nav" --><a href="./index.php">WebTester</a> &gt; About<!-- InstanceEndEditable --></div></td>
    </tr>
    <tr> 
      <td align="center" valign="top">		<div align="left"><!-- InstanceBeginEditable name="Content Area" -->
        <p align="center">WebTester 5.1 &copy; 2003-2008 Eppler Software<br>
          <a href="http://epplersoft.com"><span class="style5">http://epplersoft.com</span></a></p>
        <div align="center">
          <table width="321"  border="0" cellspacing="0" cellpadding="2">
              <tr>
                <td width="157"><p align="right"><strong>Programmer:</strong></p>
                </td>
                <td width="156"><p>Steven Eppler</p>
                </td>
              </tr>
              <tr>
                <td><p align="right"><strong>Graphics Advisor:</strong></p>
                </td>
                <td><p>Matthew Osburn</p>
                </td>
              </tr>
              <tr>
                <td><p align="right"><strong>Beta Tester:</strong></p>
                </td>
                <td><p>Jeremy Bergen</p>
                </td>
              </tr>
                  </table>
        </div>
