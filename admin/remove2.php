...
?>
    ...
    <tr> 
	  ...
	  <?php if ($_SESSION['loggedIn'] != "1") redirect_to("index.php") ?>
        <div align="center">
          <p><strong><font size="+1">Remove Files</font></strong></p>
		  <form action="delete.php?uploadFolder=<?=$_REQUEST['uploadFolder']?>" method="post">
          <p align="left">Please select a file to be removed:</p>
            <p align="left"> 
              <select name="fileToDel" id="fileToDel">
                <option value="" selected></option>
                <?php
                    $files = "";
                    $file = "";
					$var1="";
					$image_dir = realpath("../test-images/" . $_REQUEST['uploadFolder']);
