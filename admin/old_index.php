...
?>
		   ...
		   <!-- InstanceBeginEditable name="nav" --><a href="./index.php">WebTester</a> &gt; Main Menu <!-- InstanceEndEditable --></div></td>
    </tr>
    <tr> 
...
//		redirect_to("testManage.php");
	  ?>
		<p class="style7">Main Menu </p>
        <table width="500"  border="0" cellspacing="2" cellpadding="0" align="center">
          <tr class="style1">
            <td width="250"><p><a href="./testManage.php"><img src="../images/tests.png" width="48" height="48" border="0" align="absmiddle"></a> <a href="./testManage.php">Tests</a></p>
              <p>&nbsp;</p></td>
            <td width="250"><p><a href="./subjects.php"><img src="../images/subjects.png" width="48" height="48" border="0" align="absmiddle"></a> <a href="./subjects.php">Subjects</a></p>
              <p>&nbsp;</p></td>
          </tr>
          <tr class="style1">
            <td width="250"><p><a href="./currentSessions.php"><img src="../images/sessions.png" width="48" height="48" border="0" align="absmiddle"></a> <a href="./currentSessions.php">Sessions</a></p>
              <p>&nbsp;</p></td>
            <td width="250"><p><a href="viewReports.php"><img src="../images/reports.png" width="48" height="48" border="0" align="absmiddle"></a> <a href="viewReports.php">Reports</a></p>
              <p>&nbsp;</p></td>
          </tr>
          <tr class="style1">
            <td width="250"><p><a href="./preferences.php"><img src="../images/preferences.png" width="48" height="48" border="0" align="absmiddle"></a> <a href="./preferences.php">Preferences</a></p>
              <p>&nbsp;</p></td>
            <td width="250"><p><a href="./logout.php"><img src="../images/logout.png" width="48" height="48" border="0" align="absmiddle"></a> <a href="./logout.php">Logout</a></p>
              <p>&nbsp;</p></td>
          </tr>
        </table>
        <p>&nbsp;</p>
