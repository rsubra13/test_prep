...
$usersSQL="SELECT * FROM mentor ";
$myRsRes=mysql_query($usersSQL, $conn);

echo "<table border='1'>";
$i=0;
while($row = mysql_fetch_array($myRsRes)){

echo "<tr><td><a href='mentor_profile.php?id=".$row['ID']." '>" .$row['Username']. "</a></td><td>".$row['Score']."</td></tr>";  //$row['index'] the index here is a field name
