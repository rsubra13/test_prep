...
mindmaps.DefaultCanvasView = function() {
  ...
  this.init = function() {
	...
	$drawingArea.delegate("a.node-cap", "mousedown", function(e) {
      var node = $(this).parent().data("node");
      if (self.nodeMouseDown) {
        self.nodeMouseDown(node);
      }
	...
	$drawingArea.delegate("a.node-cap", "mouseup", function(e) {
      var node = $(this).parent().data("node");
      if (self.nodeMouseUp) {
        self.nodeMouseUp(node);
      }
	...
	$drawingArea.delegate("a.node-cap", "mouseover", function(e) {
      if (e.target === this) {
        var node = $(this).parent().data("node");
        if (self.nodeCaptionMouseOver) {
          self.nodeCaptionMouseOver(node);
